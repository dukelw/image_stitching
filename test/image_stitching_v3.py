...
src_img = imageio.imread("images/c1.jpg")
tar_img = imageio.imread("images/c2.jpg")
...
cv2.imwrite("v3_process.png", final_result_bgr)
plot_img(final_result, size=(20, 10), title="Final Stitched Image")
